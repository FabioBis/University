...
/**
 * Implements the JSR331 solver extending the abstract class 
...
public class Solver extends AbstractSolver {
	 ...
	 *  <dd>MaxNumberOfSolutions that is the total number of considered 
	 *  solutions that may be limited by the method setMaxNumberOfSolutions();
	 *  </dd>
	 *  <dd>TotalTimeLimit that is the number of seconds allocated for the 
	 *  entire optimization process. </dd>
	 ...
	 *  controlled by:
	 *  <dd>OptimizationTolarance that is a difference between optimal 
	 *  solutions - see setOptimizationTolarance()</dd>
	 *  <dd>MaxNumberOfSolutions that is the total number of considered 
	 *  solutions - may be limited by the method setMaxNumberOfSolutions()</dd>
	 *  <dd>TotalTimeLimit that is the number of seconds allocated for the 
	 *  entire optimization process. </dd>
