...
\include{cholesky}
\include{stabilita}
\include{interpolazione}
\include{inter_tratti}
\include{convergenza}
\include{iterativi}
...
\include{intro_aimi}
\include{pdf-float}
\include{integrazione}
\part{Matlab.}
\label{Matlab.}
\include{matlab}
\part{Esercizi.}
\label{Esercizi.}
\include{esercitazione1}
\include{esercitazione3}
\include{esercitazione5}
\include{esercitazione7}
\include{esercizi}
\part{Appendici.}
\label{Appendici}
\appendix
