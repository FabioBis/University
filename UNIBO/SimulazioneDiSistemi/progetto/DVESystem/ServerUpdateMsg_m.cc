...
int ServerUpdateMsg::getClientDest() const
{
    return clientDest_var;
}

void ServerUpdateMsg::setClientDest(int clientDest)
{
...
int ServerUpdateMsgDescriptor::getArraySize(void *object, int field) const
{
    ...
    switch (field) {
        case 2: return pp->getClientsArraySize();
        default: return 0;
    }
}
...
std::string ServerUpdateMsgDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return long2string(pp->getClients(i));
        default: return "";
    }
}
...
bool ServerUpdateMsgDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setClients(i,string2long(value)); return true;
